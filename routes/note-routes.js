...
router.get('/notes/get-all-notes', verifyToken, XAPIKEYMIDDLEWARE, getAllNotes)

router.get('/notes/get-note-by-Id/:note_id', verifyToken, XAPIKEYMIDDLEWARE, getNoteById)
