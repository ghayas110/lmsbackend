...
router.get('/papers/get-all-past-papers', verifyToken, XAPIKEYMIDDLEWARE,checkFeeStatus, getAllPastPapers)

router.get('/papers/get-past-paper-by-Id/:paper_id', verifyToken, XAPIKEYMIDDLEWARE,checkFeeStatus, getPastPaperById)
