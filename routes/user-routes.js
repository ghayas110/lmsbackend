...
const { signUp, loginUser, getAllUsers, getUserById,updateUserProfile,changePassword,approveStudentAccess ,rejectStudentAccess,getDashboardCounts} = require('../controllers/user-controller');
